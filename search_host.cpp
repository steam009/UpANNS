...
int main() {
    ...
    for(int cur_c_id=0; cur_c_id< nlist; cur_c_id++){
        std::string cache_name =  "./SPACE1B-cache/SPACEcache/SPACE1B_20_"+ std::to_string(cur_c_id) + "__decay_10_sampling_50_alpha"+ "_50_length_"+std::to_string(CACHE_LEN)+"_hbm_1.0.hbm.cluster";
