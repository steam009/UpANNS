...
g++ demo_SPACE1B.cpp -L/home/cst -lfaiss -Ifaiss -O2 -o demo_SPACE1B -DNPROBS=64 -DTOPK=10 -DBS=10

./demo_SPACE1B > res_cpuSPACEnprob64top10_BS10.txt

g++ demo_SPACE1B.cpp -L/home/cst -lfaiss -Ifaiss -O2 -o demo_SPACE1B -DNPROBS=64 -DTOPK=10 -DBS=100

./demo_SPACE1B > res_cpuSPACEnprob64top10_BS100.txt

g++ demo_SPACE1B.cpp -L/home/cst -lfaiss -Ifaiss -O2 -o demo_SPACE1B -DNPROBS=64 -DTOPK=10 -DBS=1000

./demo_SPACE1B > res_cpuSPACEnprob64top10_BS1000.txt
